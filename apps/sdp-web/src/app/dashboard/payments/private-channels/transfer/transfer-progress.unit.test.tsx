...
function makeTransfer(
  overrides: Partial<PrivateChannelTransfer> = {}
...
describe("TransferProgress", () => {
  it("shows an SPC-confirmed transfer without polling", () => {
    render(
      <TransferProgress
        transfer={makeTransfer()}
        senderLabel="Sender wallet"
        recipientLabel="Recipient wallet"
        onReset={vi.fn()}
      />
    );

    expect(screen.getByText("Confirmed in the private channel")).toBeTruthy();
