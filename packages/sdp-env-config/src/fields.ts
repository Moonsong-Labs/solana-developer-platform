...
export const FIELDS: EnvField[] = [
  ...
  },
  {
    ...
    help: "Legacy bootstrap value. Import it from the Rings dashboard to persist it per project.",
  },
  {
  ...
  },
  {
    ...
    help: "Allows plain HTTP only for the legacy environment configuration. Database setup exposes the equivalent option only in development.",
  },
  {
